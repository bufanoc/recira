...
var s="<embed type=\"application/x-shockwave-flash\" "+"src=\""+_1(String(_12))+"\" "+"id=\""+_1(String(_11.id))+"\" "+"width=\""+_1(String(_11.width))+"\" "+"height=\""+_1(String(_11.height))+"\""+((_11.style)?" style=\""+_1(String(_11.style))+"\" ":"")+"swLiveConnect=\""+_1(String(_11.swLiveConnect))+"\" "+"allowScriptAccess=\""+_1(String(_11.allowScriptAccess))+"\" "+"allowNetworking=\""+_1(String(_11.allowNetworking))+"\" "+"pluginspage=\""+window.location.protocol+"//www.adobe.com/go/getflashplayer\" ";
if(_11.params){
for(p in _11.params){
